...
yt-dlp --js-runtimes node --remote-components ejs:github -x --audio-format %AUDIO% --audio-quality 0 --download-archive "%ARCHIVE%" %RANGEFLAG% -o "%SAVE%\%%(playlist_index)s - %%(title)s.%%(ext)s" "%URL%"
